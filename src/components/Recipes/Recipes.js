...
const IngredientInput = () => {
  ...
  useEffect(() => {
    ...
    setWarningMessage(
      ...
      ¡Disfruta cocinando con Recipes! 🍽️🤖`
    );
  }, []);
  ...
  return (
    <div className="box-Recipes">
      ...
      <div className="ingredient-input box-Ingrdients">
        ...
        <button onClick={fetchRecipe} className="button-generate-recipe">Generar Receta <img src='/tenedor.png' width='30px' alt="Recipes Logo"/></button>
        ...
        {showWarning && (
          <div className="modal-overlay">
            <div className="warning-modal">
              <img width="130px" src="/logoAlert.png" alt="Recipes" className="warning-logo" />
        ...
        {recipe && (
          <div id="recipe-content" className="recipe-result" ref={recipeRef}>
            <div className="header-recipe">
              <img src='/logoComerIA.png' width='100px' alt="Recipes Logo" />
            </div>
            <h2>{recipe.title}</h2>
            <h3>Ingredientes:</h3>
            <div className="pasos">
            ...
            <div className="footer-recipe">
              <h6>Recipes puede cometer errores. Verifique la coherencia de la receta.</h6>
            </div>
          </div>
        )}
      </div>
